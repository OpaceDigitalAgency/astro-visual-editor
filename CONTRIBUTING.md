...
Keep repository documentation useful to users and contributors. Do not add
private planning, internal research, customer material, local paths or
machine-specific handover instructions.
