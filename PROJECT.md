...
Version `0.1.0-beta.3` of `@opacedev/astro-visual-editor` is published. It adds
durable local recovery, exact pre-write file review and the compact
non-overlapping editor workflow.
