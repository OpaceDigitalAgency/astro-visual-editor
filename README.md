...
process, see [Astro Theme Product and Publishing Plan](./ASTRO_THEME_PRODUCT_PLAN.md).
...
- [RELEASE_PLAN.md](./RELEASE_PLAN.md) — current test workflow, version sequence
  and takeover plan.
- [RELEASE_GUARDRAILS.md](./RELEASE_GUARDRAILS.md) — enforced publishing path,
...
- [Current engineering review](./.agent/docs/astro-visual-editor/project-review.md) — code-quality assessment.
- [Strategic product review](./.agent/docs/astro-visual-editor/strategic-product-review.md) — product priorities and recommendation changes.
- [Astro Theme Product and Publishing Plan](./ASTRO_THEME_PRODUCT_PLAN.md) — a separate reusable theme and Developer Portal submission plan.
