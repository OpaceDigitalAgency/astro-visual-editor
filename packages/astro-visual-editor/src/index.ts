...
const iconDataUrl = `data:image/png;base64,${readFileSync(
  fileURLToPath(new URL('./assets/astro-visual-editor-logo.png', import.meta.url)),
).toString('base64')}`;
const DEV_TOOLBAR_ICON = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><image width="512" height="512" href="${iconDataUrl}"/></svg>`;
